...
# This is the image processing class, look at method preprocess
...
class Preprocessor:
	...
	def preprocess(self, fn="temp1.jpg"):
		# data = base64.decodestring(data)

		# Uncomment code below to save images from json response onto local machine

		# data = jpgtxt.split(',')[-1]
		# data = base64.b64decode(data.encode('ascii'))
		# g = open("temp16.jpg", "wb")
		# g.write(data)
		# g.close()
	...
	@staticmethod
	def rgb2gray(rgb):
		# This just creates a gray matrix of all 0.. because r,g,b are all 0..
	...
	@staticmethod
	def normalize(M):
		# M is attached in M.txt

		# np.std(M) standard deviation is 
		# 598.942520099
		sigma = np.std(M)
		mean = np.mean(M)
		# Mean is 
